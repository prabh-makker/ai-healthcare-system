...
from .endpoints import auth, diagnosis, records, patients, appointments, prescriptions, medications, notifications, messages, admin, attendance, doctor_calendar, ws, disease_prediction, retrain, models
