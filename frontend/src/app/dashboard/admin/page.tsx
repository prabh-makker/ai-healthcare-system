...
import { Users, BarChart3, Activity, TrendingUp, Database, Shield, AlertCircle, Clock } from "lucide-react";
      ...
      >
        {[
          ...
          >
            ...
            <div className={`p-3 rounded-2xl w-fit mb-4 bg-${card.color}-500/10 group-hover:bg-${card.color}-500/20 relative z-10`}>
            ...
            {(stats?.recent_records ?? []).slice(0, 5).map((r, idx) => (
              ...
              >
                ...
                <div className="text-right">
                  <span className="inline-block text-xs font-bold px-2.5 py-1.5 rounded-lg bg-sky-500/10 text-sky-400">
