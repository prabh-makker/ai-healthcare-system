    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
      <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="flex flex-wrap justify-between items-start gap-6 mb-12">
        <div>
          <div className="flex items-center gap-3 mb-1">
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, #5eead4, #22d3ee, #818cf8)", boxShadow: "0 8px 24px rgba(34,211,238,0.35)" }}
              animate={{ scale: [1, 1.1, 1] }}
              transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut" }}
            >
              <HeartPulse size={22} className="text-white" />
            </motion.div>
            <PulseDots color="#22d3ee" />
          </div>
          <h1
            className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight"
            style={{ backgroundImage: "linear-gradient(135deg, #5eead4, #22d3ee, #38bdf8, #818cf8, #c084fc)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}
          >
            My Health Portal
          </h1>
        ...
        <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
          <NotificationBell />
          <ShimmerButton href="/dashboard/symptoms" gradFrom="#22d3ee" gradTo="#818cf8" shadow="rgba(129,140,248,0.35)">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8 sm:mb-12 overflow-hidden">
        <StatCard3D label="Health Score" value={stats?.recent_records?.length ? "Active" : "—"} icon={HeartPulse} trend={stats?.recent_records?.length ? "tracked" : "no data"} gradFrom="#5eead4" gradTo="#818cf8" glowColor="rgba(94,234,212,0.25)" delay={0} />
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        <section className="xl:col-span-2">
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-xl font-bold" style={{ backgroundImage: "linear-gradient(135deg, #5eead4, #22d3ee, #818cf8)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}>
              Recent Diagnoses
            </h2>
